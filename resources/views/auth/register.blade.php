 ...
 <div class="modal-dialog login-form">
           <div class="modal-content">
               <div class="modal-heading">
                   <h2 class="text-center text-uppercase" style="color:#337ab7;">sign Up</h2>
               </div>
               <hr/>
        <div class="modal-body ">
                    <form class="form-horizontal pad" role="form" method="POST" action="{{ route('register') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('location') ? ' has-error' : '' }}">
                                ...
                                <input id="location" placeholder="location" type="text" class="form-control" name="location" value="{{ old('location') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                ...
                                <input id="phone" type="text" placeholder="phone" class="form-control" name="phone" value="{{ old('phone') }}" required autofocus>
